...
#Region "GESTION DES POLICES"
    ...
    '    'Dim sFont As String = LoadResString(ArrFontAFM(ID).ID)
    ...
    Private Function GetCharSize(ByVal ID As Integer) As Integer()
        ...
        Dim sLines() As String = Split(LoadResString(ArrFontAFM(ID).ID), vbCrLf)
...
#Region "GESTION DES RESOURCES"

    'Renvoi le texte contenu dans une resource de type String depuis son nom
    Private Function LoadResString(ByRef ID As String) As String
        'Dim ResString As Global.System.Resources.ResourceManager = New Global.System.Resources.ResourceManager(Application.ProductName & ".Resources", GetType(cPDF).Assembly)
        'Return ResString.GetString(ID)
    End Function
